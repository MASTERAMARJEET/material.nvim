...
theme.loadLSP = function()
	...
	local lsp = {
		...
		-- LspReferenceText =                      { fg = colors.white, bg = colors.selection }, -- used for highlighting "text" references
		-- LspReferenceRead =                      { fg = colors.white, bg = colors.selection }, -- used for highlighting "read" references
		-- LspReferenceWrite =                     { fg = colors.white, bg = colors.selection }, -- used for highlighting "write" references
